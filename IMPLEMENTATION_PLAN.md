...
### TASK-8.7: UI Repo Column ✅ COMPLETE
...
- [x] Repo column shows 📦 badge with repo name (only when multi-repo issues exist)
- [x] Column is sortable and displays "—" for issues without target_repo
